...
return [
    ...
    */
    ...
    | specify these mappings, as they can be helpful when debugging.
    |
    ...
    */
    ...
    /*
     ...
     | (if you included css, it includes font-awesome bundled css)
     |
     */
    ...
    /*
     ...
     |
     | Optionally, you can also send ServerTiming headers on ajax requests for
     | the Chrome DevTools.
     |
     */
